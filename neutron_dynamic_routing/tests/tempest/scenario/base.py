...
class BgpSpeakerTestJSONBase(base.BaseAdminNetworkTest):
    ...
    PNet = Net(net='172.24.6.0', mask=24, cidr='172.24.6.0/24', router=None)
    TNet = Net(net='10.10.0.0', mask=28, cidr='10.10.0.0/28', router=None)
    AS = collections.namedtuple('AS', 'asn, router_id, adv_net')
    L_AS = AS(asn='64512', router_id='192.168.0.1', adv_net='10.10.0.0/28')
