...
class TestRescheduleBgpSpeaker(TestBgpDrAgentSchedulerBaseTestCase,
    ...
    def test_reschedule_bgp_speaker_binded_down_agent(self):
        ...
        self.plugin.remove_bgp_speaker_from_down_agents()
    ...
    def test_schedule_unbind_bgp_speaker(self):
        ...
        self.assertEqual(self.scheduler.schedule_unscheduled_bgp_speakers(
            self.ctx, self.host1), True)
        binds = self._get_dragent_bgp_speaker_bindings(self.bgp_speaker_id)
